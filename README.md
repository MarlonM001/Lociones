...
Tienda de perfumería (Árabes, Mujeres, Caballero) construida con React + Vite + Tailwind CSS. El flujo de compra se confirma por WhatsApp; incluye cuentas de cliente, panel de administración, moderación de referencias en video y reportes de ventas en PDF.
