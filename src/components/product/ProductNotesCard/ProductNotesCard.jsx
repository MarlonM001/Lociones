  ...
  return (
    <div className="relative h-full w-full bg-white">
      ...
      <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-ink via-ink/85 to-transparent px-4 pb-4 pt-12 sm:px-6 sm:pb-6">
        <p className="mb-2 text-center text-[10px] uppercase tracking-widest-plus text-gold">
          Acordes principales
        </p>
        <div className="flex flex-wrap justify-center gap-1.5">
          {notes.map((note, index) => (
            <span
              key={note}
              className="rounded-full px-2.5 py-1 text-[10px] font-medium capitalize text-ink shadow-sm sm:text-xs"
