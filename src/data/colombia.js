/**
 * Departamentos y municipios de Colombia, en orden alfabético, para los selectores
 * Departamento y Ciudad del formulario de compra.
 *
 * Fuente: DIVIPOLA del DANE (datos.gov.co, conjunto "Departamentos y municipios de
 * Colombia", gdxc-w37w). Incluye los 1.103 municipios, las áreas no municipalizadas
 * de Amazonas, Guainía y Vaupés y la isla de San Andrés: 1.122 lugares en 33
 * departamentos (Bogotá D.C. cuenta como departamento con una sola ciudad).
 * Los nombres se pasaron de MAYÚSCULAS a mayúscula inicial.
 */
export const COLOMBIA_DEPARTMENTS = [
  {
    name: 'Amazonas',
    cities: [
      'El Encanto', 'La Chorrera', 'La Pedrera', 'La Victoria', 'Leticia', 'Mirití - Paraná', 'Puerto Alegría',
      'Puerto Arica', 'Puerto Nariño', 'Puerto Santander', 'Tarapacá',
    ],
  },
  {
    name: 'Antioquia',
    cities: [
      ...
      'Carolina', 'Caucasia', 'Chigorodó', 'Cisneros', 'Ciudad Bolívar', 'Cocorná', 'Concepción', 'Concordia',
      'Copacabana', 'Dabeiba', 'Donmatías', 'Ebéjico', 'El Bagre', 'El Carmen de Viboral', 'El Santuario',
      ...
      'La Pintada', 'La Unión', 'Liborina', 'Maceo', 'Marinilla', 'Medellín', 'Montebello', 'Murindó', 'Mutatá',
      ...
      'San Andrés de Cuerquía', 'San Carlos', 'San Francisco', 'San Jerónimo', 'San José de la Montaña',
      'San Juan de Urabá', 'San Luis', 'San Pedro de los Milagros', 'San Pedro de Urabá', 'San Rafael', 'San Roque',
      'San Vicente Ferrer', 'Santa Bárbara', 'Santa Fé de Antioquia', 'Santa Rosa de Osos', 'Santo Domingo',
  ...
  },
  {
    ...
    cities: [
      ...
      'Cartagena de Indias', 'Cicuco', 'Clemencia', 'Córdoba', 'El Carmen de Bolívar', 'El Guamo', 'El Peñón',
      ...
      'Santa Cruz de Mompox', 'Santa Rosa', 'Santa Rosa del Sur', 'Simití', 'Soplaviento', 'Talaigua Nuevo',
  ...
  },
  {
    ...
    cities: [
      ...
      'Gámeza', 'Garagoa', 'Guacamayas', 'Guateque', 'Guayatá', 'Güicán de la Sierra', 'Iza', 'Jenesano', 'Jericó',
      'La Capilla', 'La Uvita', 'La Victoria', 'Labranzagrande', 'Macanal', 'Maripí', 'Miraflores', 'Mongua',
      'Monguí', 'Moniquirá', 'Motavita', 'Muzo', 'Nobsa', 'Nuevo Colón', 'Oicatá', 'Otanche', 'Pachavita', 'Páez',
      'Paipa', 'Pajarito', 'Panqueba', 'Pauna', 'Paya', 'Paz de Río', 'Pesca', 'Pisba', 'Puerto Boyacá', 'Quípama',
      ...
      'Tasco', 'Tenza', 'Tibaná', 'Tibasosa', 'Tinjacá', 'Tipacoque', 'Toca', 'Togüí', 'Tópaga', 'Tota', 'Tunja',
      'Tununguá', 'Turmequé', 'Tuta', 'Tutazá', 'Úmbita', 'Ventaquemada', 'Villa de Leyva', 'Viracachá', 'Zetaquira',
    ],
  },
  {
    name: 'Caldas',
    cities: [
      ...
      'Manizales', 'Manzanares', 'Marmato', 'Marquetalia', 'Marulanda', 'Neira', 'Norcasia', 'Pácora', 'Palestina',
  ...
  },
  {
    name: 'Caquetá',
    cities: [
      'Albania', 'Belén de los Andaquíes', 'Cartagena del Chairá', 'Curillo', 'El Doncello', 'El Paujíl', 'Florencia',
  ...
  },
  {
    ...
    cities: [
      ...
      'Mercaderes', 'Miranda', 'Morales', 'Padilla', 'Páez', 'Patía', 'Piamonte', 'Piendamó - Tunía', 'Popayán',
      'Puerto Tejada', 'Puracé', 'Rosas', 'San Sebastián', 'Santa Rosa', 'Santander de Quilichao', 'Silvia',
      'Sotará - Paispamba', 'Suárez', 'Sucre', 'Timbío', 'Timbiquí', 'Toribío', 'Totoró', 'Villa Rica',
    ],
  },
  {
    name: 'Cesar',
    cities: [
      ...
      'El Copey', 'El Paso', 'Gamarra', 'González', 'La Gloria', 'La Jagua de Ibirico', 'La Paz',
  ...
  },
  {
    ...
    cities: [
      ...
      'Juradó', 'Lloró', 'Medio Atrato', 'Medio Baudó', 'Medio San Juan', 'Nóvita', 'Nuevo Belén de Bajirá', 'Nuquí',
      'Quibdó', 'Río Iró', 'Río Quito', 'Riosucio', 'San José del Palmar', 'Sipí', 'Tadó', 'Unguía',
      'Unión Panamericana',
    ],
  },
  {
    ...
    cities: [
      ...
      'Lorica', 'Los Córdobas', 'Momil', 'Moñitos', 'Montelíbano', 'Montería', 'Planeta Rica', 'Pueblo Nuevo',
      'Puerto Escondido', 'Puerto Libertador', 'Purísima de la Concepción', 'Sahagún', 'San Andrés de Sotavento',
      'San Antero', 'San Bernardo del Viento', 'San Carlos', 'San José de Uré', 'San Pelayo', 'Tierralta', 'Tuchín',
      'Valencia',
    ],
  },
  {
    ...
    cities: [
      ...
      'Medina', 'Mosquera', 'Nariño', 'Nemocón', 'Nilo', 'Nimaima', 'Nocaima', 'Pacho', 'Paime', 'Pandi',
      'Paratebueno', 'Pasca', 'Puerto Salgar', 'Pulí', 'Quebradanegra', 'Quetame', 'Quipile', 'Ricaurte',
      'San Antonio del Tequendama', 'San Bernardo', 'San Cayetano', 'San Francisco', 'San Juan de Rioseco', 'Sasaima',
      ...
      'Ubalá', 'Ubaque', 'Une', 'Útica', 'Venecia', 'Vergara', 'Vianí', 'Villa de San Diego de Ubaté', 'Villagómez',
  ...
  },
  {
    name: 'Guainía',
    cities: [
      'Barrancominas', 'Cacahual', 'Inírida', 'La Guadalupe', 'Morichal', 'Pana Pana', 'Puerto Colombia',
      'San Felipe',
    ],
  },
  {
  ...
  },
  {
    name: 'Magdalena',
    cities: [
      'Algarrobo', 'Aracataca', 'Ariguaní', 'Cerro de San Antonio', 'Chivolo', 'Ciénaga', 'Concordia', 'El Banco',
      'El Piñón', 'El Retén', 'Fundación', 'Guamal', 'Nueva Granada', 'Pedraza', 'Pijiño del Carmen', 'Pivijay',
      'Plato', 'Puebloviejo', 'Remolino', 'Sabanas de San Ángel', 'Salamina', 'San Sebastián de Buenavista',
  ...
  },
  {
    name: 'Nariño',
    cities: [
      'Albán', 'Aldana', 'Ancuya', 'Arboleda', 'Barbacoas', 'Belén', 'Buesaco', 'Chachagüí', 'Colón', 'Consacá',
      'Contadero', 'Córdoba', 'Cuaspud Carlosama', 'Cumbal', 'Cumbitara', 'El Charco', 'El Peñol', 'El Rosario',
      'El Tablón de Gómez', 'El Tambo', 'Francisco Pizarro', 'Funes', 'Guachucal', 'Guaitarilla', 'Gualmatán', 'Iles',
      'Imués', 'Ipiales', 'La Cruz', 'La Florida', 'La Llanada', 'La Tola', 'La Unión', 'Leiva', 'Linares',
      'Los Andes', 'Magüí', 'Mallama', 'Mosquera', 'Nariño', 'Olaya Herrera', 'Ospina', 'Pasto', 'Policarpa',
      'Potosí', 'Providencia', 'Puerres', 'Pupiales', 'Ricaurte', 'Roberto Payán', 'Samaniego',
      'San Andrés de Tumaco', 'San Bernardo', 'San Lorenzo', 'San Pablo', 'San Pedro de Cartago', 'Sandoná',
      'Santa Bárbara', 'Santacruz', 'Sapuyes', 'Taminango', 'Tangua', 'Túquerres', 'Yacuanquer',
    ],
  },
  {
    ...
    cities: [
      ...
      'La Playa', 'Labateca', 'Los Patios', 'Lourdes', 'Mutiscua', 'Ocaña', 'Pamplona', 'Pamplonita',
      'Puerto Santander', 'Ragonvalia', 'Salazar', 'San Calixto', 'San Cayetano', 'San José de Cúcuta', 'Santiago',
  ...
  },
  {
    ...
    cities: [
      ...
      'San José de Toluviejo', 'San Juan de Betulia', 'San Luis de Sincé', 'San Marcos', 'San Onofre', 'San Pedro',
      'Santiago de Tolú', 'Sincelejo', 'Sucre',
    ],
  },
  {
    name: 'Tolima',
    cities: [
      ...
      'Guamo', 'Herveo', 'Honda', 'Ibagué', 'Icononzo', 'Lérida', 'Líbano', 'Melgar', 'Murillo', 'Natagaima',
      'Ortega', 'Palocabildo', 'Piedras', 'Planadas', 'Prado', 'Purificación', 'Rioblanco', 'Roncesvalles', 'Rovira',
      'Saldaña', 'San Antonio', 'San Luis', 'San Sebastián de Mariquita', 'Santa Isabel', 'Suárez',
  ...
  },
  {
    ...
    cities: [
      'Alcalá', 'Andalucía', 'Ansermanuevo', 'Argelia', 'Bolívar', 'Buenaventura', 'Bugalagrande', 'Caicedonia',
      'Calima', 'Candelaria', 'Cartago', 'Dagua', 'El Águila', 'El Cairo', 'El Cerrito', 'El Dovio', 'Florida',
      'Ginebra', 'Guacarí', 'Guadalajara de Buga', 'Jamundí', 'La Cumbre', 'La Unión', 'La Victoria', 'Obando',
      'Palmira', 'Pradera', 'Restrepo', 'Riofrío', 'Roldanillo', 'San Pedro', 'Santiago de Cali', 'Sevilla', 'Toro',
