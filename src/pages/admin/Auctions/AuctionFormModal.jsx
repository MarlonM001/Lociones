              ...
              {searchResults.length > 0 && (
                <div className="absolute z-10 mt-1 w-full overflow-hidden rounded-lg border border-ivory/10 bg-charcoal shadow-xl">
                  {searchResults.map((product) => (
                    ...
                    >
                      <img src={product.image} alt="" loading="lazy" decoding="async" className="h-8 w-8 rounded bg-white object-contain p-0.5" />
            ...
            {items.map((item) => {
              ...
              return (
                <div key={item.id} className="flex items-center gap-3 rounded-lg border border-ivory/5 bg-ink px-3 py-2">
                  <img src={item.image} alt="" loading="lazy" decoding="async" className="h-10 w-10 rounded bg-white object-contain p-0.5" />
